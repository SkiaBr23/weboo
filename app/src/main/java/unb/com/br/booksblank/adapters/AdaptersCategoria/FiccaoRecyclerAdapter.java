...
public class FiccaoRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FiccaoRecyclerAdapter(Context context, ListAdapterListener listAdapterListener) {
    ...
    private void configureViewHolderCapa (RecyclerViewCapaCategoria rvcc, int position) {
        rvcc.primeiraCapaCategoria.setImageBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.capa_categoria_ficcao));
    }
