...
public class RecyclerViewCategoriasHorizont extends RecyclerView.ViewHolder implements View.OnClickListener{

    public TextView tituloLivro;
    public ImageView capaLivro;
    public LinearLayout progressBar;

    public RecyclerViewCategoriasHorizont(View itemView) {
        super(itemView);
