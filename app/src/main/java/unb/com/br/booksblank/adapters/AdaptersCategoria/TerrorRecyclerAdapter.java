package unb.com.br.booksblank.adapters.AdaptersCategoria;
...
import unb.com.br.booksblank.adapters.RecyclerViewCapaCategoria;
import unb.com.br.booksblank.adapters.RecyclerViewCategoriasHorizont;


public class TerrorRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TerrorRecyclerAdapter(Context context, ListAdapterListener listAdapterListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 0:
                layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_layout_primeira_capa, null);
                vHolder = new RecyclerViewCapaCategoria(layoutView);
                break;
            case 1:
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        switch (holder.getItemViewType()) {
            case 0:
                RecyclerViewCapaCategoria recyclerViewCapaCategoria = (RecyclerViewCapaCategoria)holder;
                configureViewHolderCapa(recyclerViewCapaCategoria,position);
                break;
            case 1:
    ...
    private void configureViewHolderCapa (RecyclerViewCapaCategoria rvcc, int position) {
        rvcc.primeiraCapaCategoria.setImageBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.capa_categoria_terror));
    }
