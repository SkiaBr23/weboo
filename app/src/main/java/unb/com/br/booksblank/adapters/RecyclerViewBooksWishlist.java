...
public class RecyclerViewBooksWishlist extends RecyclerView.ViewHolder implements View.OnClickListener{

    //public TextView tituloLivro;
    public ImageView capaLivro;
   // public TextView txtDisponibilidade;
    public LinearLayout progressBar;

    public RecyclerViewBooksWishlist(View itemView) {
        super(itemView);
        ...
        progressBar = (LinearLayout)itemView.findViewById(R.id.progressBarWishlist);
    }
