...
public class AventuraRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AventuraRecyclerAdapter(Context context, ListAdapterListener listAdapterListener) {
