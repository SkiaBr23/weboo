...
public class AcaoRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AcaoRecyclerAdapter(Context context, ListAdapterListener listAdapterListener) {
    ...
    private void configureViewHolderCapa (RecyclerViewCapaCategoria rvcc, int position) {
        rvcc.primeiraCapaCategoria.setImageBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.capa_categoria_action));
    }
